...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-20 mx-auto z-40 relative select-none">
            <Container delay={0.0}>
            ...
            <BlurText
                word={"Streamline hiring with AI"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Transform recruitment with the power of AI, upload CVs and job descriptions to get instant compatibility scores. NxtHireAI is the all-in-one solution for your recruitment and job needs.
                </p>
            </Container>
            <Container delay={0.2}>
            ...
            <Container delay={0.3}>
                <div className="relative mx-auto max-w-7xl rounded-xl lg:rounded-[32px] border border-neutral-200/50 p-2 backdrop-blur-lg border-neutral-700 bg-neutral-800/50 md:p-4 mt-12">
                    ...
                    <div className="rounded-lg lg:rounded-[24px] bg-black">
                        <Image
